<template>
  <div class="coupon-bag">
    ...
    <!-- 底部弹出商品信息 -->
    <div ref="CouponBagBtmPopup" class="coupon-bag-toast-wrap" :style="couponBagToastStyle"> 
      <CouponBagBtmPopup
        :useIndex="useIndex" 
        :usePageIndex="usePageIndex" 
        :itemCouponDetail="itemCouponDetail" 
        :couponBagToastStyle="couponBagToastStyle"
        @goUse="goUse">
      </CouponBagBtmPopup>
    </div>
    <!-- 分享规则 -->
...
<script>
  ...
  import CouponBagBtmPopup from '../../base/coupon-bag-btm-popup/coupon-bag-btm-popup'
    ...
    methods: {
      ...
      bannerClick(){
        if(this.merchantId === '100036'){
          window.location.href = 'https://c1.51jujibao.com/static/mkt/2019/11/upass/wofen-useRule.html?t=001'
      ...
      openCouponBagToast(){
        this.couponBagToast = true
        this.$refs.CouponBagBtmPopup.style.bottom = "0"
        this.$refs.CouponBagBtmPopup.style.transition = "bottom 0.5s ease"
      },
      closeCouponBagToast(){
        ...
        this.$refs.CouponBagBtmPopup.style.bottom = "-100%"
        this.$refs.CouponBagBtmPopup.style.transition = "bottom 0.5s ease"
